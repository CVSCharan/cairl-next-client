      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="max-w-sm sm:max-w-md md:max-w-lg lg:max-w-2xl xl:max-w-3xl 2xl:max-w-4xl text-sm sm:text-base md:text-lg lg:text-xl text-muted-foreground mx-auto leading-relaxed sm:leading-relaxed md:leading-relaxed lg:leading-relaxed font-medium mb-2 sm:mb-3 md:mb-4"
            style={{
          ...
          >
            Our team brings together experts from diverse fields to create
            innovative AI applications that address real-world challenges,
            enhance user experiences, and promote the responsible use of
            technology.
          </motion.p>
